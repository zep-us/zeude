...
export default function DemoLandingPage() {
  return (
    <div className={`${styles.page} ${headingFont.variable} ${monoFont.variable}`}>
      <div className={styles.backdrop} />
      <header className={`${styles.nav} ${styles.reveal0}`}>
        <div className={styles.brand}>
          <Image src="/Zep-logo-full.svg" alt="Zeude" className={styles.logo} width={132} height={32} priority />
